...
def main(analyze, submit_mode=False):
    ...
    if opt.BATCH and not opt.RUN:
        ...
        for sample in samples_to_process:
            ...
            params = {}
            params['TEMPL_NEVENTS'] = opt.NEVENTS
        ...
        dagman_file_name = os.path.join(batch_dir, 'dagman_'+sample.name+'.dag')
        ...
        print ('going to make ntuple-tools.tar.gz file')
        ...
        cwd = os.getcwd()
        print (cwd)
        os.system('tar -czvf ntuple-tools.tar.gz set* runHarvesting.py analyzeHgcalL1Tntuple.py src/ cfg/ python/')
        os.system('mv ntuple-tools.tar.gz '+batch_dir)
